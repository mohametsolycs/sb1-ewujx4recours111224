...
interface InsuranceCompanySelectorProps {
  ...
  onSelect: (type: 'requester' | 'responsible', value: string | null) => void;
  onFilter: () => void;
  onReset: () => void;
  compact?: boolean;
}
...
export function InsuranceCompanySelector({
  ...
  if (compact) {
    return renderDropdown('requester');
  }
    ...
    <div className="space-y-6">
      ...
      {!compact && (
        <div className="flex justify-end space-x-3">
          ...
          <Button
            onClick={onFilter}
            disabled={!selectedInsurers.requester || !selectedInsurers.responsible}
          >
            Filtrer
          </Button>
        </div>
